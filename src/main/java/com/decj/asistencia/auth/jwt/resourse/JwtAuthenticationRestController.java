...
import com.decj.asistencia.auth.jwt.JwtTokenUtil;
import com.decj.asistencia.auth.jwt.JwtUserDetails;
...
public class JwtAuthenticationRestController {
  ...
  public ResponseEntity<?> createAuthenticationToken(@RequestBody JwtTokenRequest authenticationRequest)
    ...
    jwtTokenResponse.setOk(true);
    jwtTokenResponse.setMsg("");
    jwtTokenResponse.setName(authenticationRequest.getUsername());    
  ...
  public ResponseEntity<?> refreshAndGetAuthenticationToken(HttpServletRequest request) {
    ...
    if (jwtTokenUtil.canTokenBeRefreshed(token)) {
      ...
      JwtTokenResponse jwtTokenResponse =  new JwtTokenResponse(refreshedToken);
      jwtTokenResponse.setOk(true);
      jwtTokenResponse.setMsg("");
      jwtTokenResponse.setName(username);    
